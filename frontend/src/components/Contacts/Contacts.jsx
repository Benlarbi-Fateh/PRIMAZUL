    ...
    <div className="mb-6 max-w-2xl mx-auto">
      ...
      <div
        className={`flex gap-4 overflow-x-auto p-[1px] rounded-xl border-2 ${
          isDark ? "bg-blue-900/50 border-blue-800" : "bg-white/80 border-blue-100"
        }`}
      >
    ...
    try {
      ...
      if (
        ...
        if (error.response?.data?.conversation?._id) {
          ...
          console.log(
            `🔧 Conversation ID trouvée malgré l'erreur: ${conversationId}`
          );
          router.push(`/chat/${conversationId}`);
          return;
        }
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className={`rounded-3xl p-6 sm:p-8 border-2 ${cardBg} relative`}>
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <button
              className={`flex flex-col items-center gap-2 p-4 rounded-2xl ${actionButtonStyle}`}
            >
              <div
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={
                          sendingTo === user._id || isInvitationSent
                        }
    ...
    const fetchBlockedUsers = async () => {
      try {
        ...
        const blockedIds = new Set(
          blockedUsers.map((u) => u._id.toString())
        );
        ...
        <div className="mt-4">
          {activeTab === "add" ? (
            ...
            <>
              ...
              <div className="max-w-2xl mx-auto">
                <h2
                  className={`font-bold text-lg mb-3 ${textPrimary}`}
                >
