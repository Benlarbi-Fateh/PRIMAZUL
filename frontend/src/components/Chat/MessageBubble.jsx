            ...
            >
              ...
              <div className="relative">
                <button
                  ...
                  className="p-1 rounded-full hover:bg-gray-500 transition opacity-300 lg:opacity-0 lg:group-hover:opacity-300"
                >
  ...
  const renderVoiceMessage = () => {
    ...
    return (
      <div className={`flex flex-col ${isMine ? "items-end" : "items-start"}`}>
        ...
        <div
          className={`flex items-center gap-2 ${isMine ? "flex-row-reverse animate-slide-in-right" : "flex-row animate-slide-in-left"}`}
        >
          {!isMine && (
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  className={`relative w-56 h-44 sm:w-64 sm:h-52 ${isDark ? "bg-slate-800" : "bg-slate-100"}`}
                >
                  <Image
                    src={message.fileUrl}
