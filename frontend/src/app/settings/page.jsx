...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 p-4 md:p-8">
      ...
      <button
        onClick={() => router.back()}
        className="fixed top-6 left-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg border border-slate-200 hover:border-blue-400 hover:scale-110 transition-all"
      >
