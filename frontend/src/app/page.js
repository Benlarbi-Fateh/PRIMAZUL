    ...
    <ProtectedRoute>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="hidden lg:flex flex-1 flex-col min-h-0">
          ...
          {/* Contenu avec fond clair bleuâtre */}
          <div 
            className="flex-1 flex items-center justify-center p-4 min-h-0 overflow-hidden relative"
          >
            {/* Fond dégradé clair bleuâtre */}
            <div className="absolute inset-0 bg-linear-to-br from-blue-50 via-slate-50 to-indigo-50">
              {/* Effets de vagues subtiles */}
              ...
              <div className="absolute top-10 right-10 w-32 h-32 border-2 border-blue-200/20 rounded-3xl rotate-45"></div>
              <div className="absolute bottom-10 left-10 w-24 h-24 border-2 border-indigo-200/20 rounded-2xl rotate-12"></div>
            </div>
