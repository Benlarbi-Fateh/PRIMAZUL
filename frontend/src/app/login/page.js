  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.requiresVerification) {
        ...
        router.push('/'); // ✅ REDIRECTION AJOUTÉE
      }
    } catch (error) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-12 h-12 bg-linear-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center">
                <MessageCircle className="w-6 h-6 text-white" />
              </div>
          ...
          <div className="lg:hidden mt-8 grid grid-cols-3 gap-4 text-center">
            ...
            <div className="flex flex-col items-center text-gray-600 p-3 bg-white/50 rounded-2xl backdrop-blur-sm">
              <Sparkles className="w-5 h-5 mb-1 text-blue-500" />
