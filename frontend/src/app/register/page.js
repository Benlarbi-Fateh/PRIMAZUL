...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-2/5 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 p-8 flex-col justify-between relative overflow-hidden">
        ...
        {/* Logo centré en haut avec marge */}
        <div className="flex flex-col items-center justify-center text-center relative z-10 mt-12">
          <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm mb-3 border border-white/30">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-blue-50 to-gray-100">
              ...
              <>
                ...
                <div className="mt-6 sm:mt-8 text-center">
                  <p className="text-gray-600 text-sm sm:text-base">
                    ...
                    <Link 
                      href="/login" 
                      className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 inline-flex items-center gap-2 shadow-md hover:shadow-lg transform hover:scale-105 text-sm sm:text-base"
                    >
