            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project) => (
                <div
                  ...
                  className={`group p-6 rounded-2xl border cursor-pointer transition-all ${cardBg}`}
                >
                  ...
                  <h3 className={`text-lg font-bold mt-4 ${textPrimary}`}>
                    {project.name}
                  </h3>

                  <div
                    className={`flex items-center gap-2 mt-3 text-sm ${textMuted}`}
                  >
